...
public class ManagerImplTest {
	public static void main(String[] args) {
		//ManagerImpl mi = new ManagerImpl(); //List를 이용하여 구현한 구현체
		
		//기존 테스트 코드 그대로 ManagerImpl대신 ManagerImpl2 이용
		ManagerImpl2 mi = new ManagerImpl2();	//Map을 이용하여 구현한 구현체
		Info info1 = new Info(0L, "홍길동", LocalDate.now(), "A");
		Info info2 = new Info("이순신", LocalDate.now(), "B");
